...
The package also includes auxiliary functions such as `ET0_HS.R`, `ET0_PM.R`, and `ET0_PT.R`. These functions may be used for calculating daily potential Evapotranspiration rate, using Hargreaves-Samani, Penman and Monteith, and Preistley-Taylor methods. respectively.
